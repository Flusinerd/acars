    ...
    FSUIPCInterface.prototype.connectToSim = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._api.init()];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.connectToSim()];
                                case 1:
                                    _a.sent();
                                    console.log('Getting current info');
                                    currentInfo = this.flightTrackingObs.pipe(operators_1.first()).subscribe(function (currentInfo) {
                                        ...
                                        // Check distance
                                        var distance = _this._getDistanceFromLatLonInKm(airport.lat, airport.long, currentInfo.latitude, currentInfo.longitude);
